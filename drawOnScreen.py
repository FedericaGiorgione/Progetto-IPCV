...
class HandsDetection():
    ...
    def Landmarks(self, frame, canvas, draw=True):
        ...
        if self.results.multi_hand_landmarks:
            ...
            x, y = int(self.results.multi_hand_landmarks[0].landmark[8].x * w), int(
                self.results.multi_hand_landmarks[0].landmark[8].y * h)

            x2, x4 = self.results.multi_hand_landmarks[0].landmark[2].x * w, \
                     self.results.multi_hand_landmarks[0].landmark[4].x * w
            if x4 > x2:
                b[0] = 0
            elif x4 < x2:
                b[0] = 1
            ...
            y6, y8 = self.results.multi_hand_landmarks[0].landmark[6].y * h, \
                     self.results.multi_hand_landmarks[0].landmark[8].y * h
            if y8 < y6:
                b[1] = 1
            elif y8 > y6:
            ...
            y10, y12 = self.results.multi_hand_landmarks[0].landmark[10].y * h, \
                       self.results.multi_hand_landmarks[0].landmark[12].y * h
            if y12 < y10:
                b[2] = 1
            elif y12 > y10:
                b[2] = 0
            ...
            y14, y16 = self.results.multi_hand_landmarks[0].landmark[14].y * h, \
                       self.results.multi_hand_landmarks[0].landmark[16].y * h
            if y16 < y14:
                b[3] = 1
            elif y16 > y14:
                b[3] = 0
            ...
            y18, y20 = self.results.multi_hand_landmarks[0].landmark[18].y * h, \
                       self.results.multi_hand_landmarks[0].landmark[20].y * h
            if y20 < y18:
                b[4] = 1
            elif y20 > y18:
                b[4] = 0
